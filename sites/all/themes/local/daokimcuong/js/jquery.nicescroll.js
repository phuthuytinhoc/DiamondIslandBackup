...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        cursor.css({
          position:"relative",top:0,right:"5px","float":"right" ,'width' : self.opt.cursorwidth ,height:"0px",
...
//
    ...
    this.onResize = function(e,page) {
      ...
      self.cursorheight = 50;//Math.min(self.view.h,Math.round(self.view.h * (self.view.h / self.page.h)));
